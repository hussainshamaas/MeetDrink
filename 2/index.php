...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
		Find that cutie you've been eyeing at the bar and impress her! 
      </h1>
      </section>
    ...
    <section class="content">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Select your location, gender, occuputation and age limit. We'll tell you how she likes it ;)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <form method="POST" action="">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE drinkname = 'Angry Orchard' AND borough = 'Queens';";

                if(isset($_POST['filter'])  && $_POST['location']!="Select" && $_POST['occupation']!='Select' && $_POST['age']!="" &&  $_POST['sex'] !="Select"){
                  ...
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE  age<='$age' AND gender='$sex' AND borough = '$location' AND occupation='$occupuation';";
                }
				 ...
				 if(isset($_POST['filter'])  && $_POST['location']!="Select" && $_POST['occupation']!='Select' && $_POST['age']=="" &&  $_POST['sex'] !="Select"){
                  ...
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE  gender='$sex' AND borough = '$location' AND occupation='$occupuation';";
                }
                if(isset($_POST['filter']) && $_POST['location']=="Select" && $_POST['occupation']=='Select' && $_POST['age']!="" &&  $_POST['sex'] =="Select"){
                  $location = $_POST['location'];
				  $occupuation = $_POST['occupation'];
                  ...
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE age<='$age' ORDER BY age DESC LIMIT 100 ;";
                }
				 ...
				 if(isset($_POST['filter']) && $_POST['location']=="Select" && $_POST['occupation']!='Select' && $_POST['age']!="" &&  $_POST['sex'] =="Select"){
                  ...
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE age<='$age' AND occupation='$occupuation' ;";
                }
				 ...
				 if(isset($_POST['filter']) && $_POST['location']=="Select" && $_POST['occupation']!='Select' && $_POST['age']=="" &&  $_POST['sex'] !="Select"){
                  ...
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE occupation='$occupuation' AND gender='$sex' ;";
                }
				 if(isset($_POST['filter'])  && $_POST['location']!="Select" && $_POST['occupation']!='Select' && $_POST['age']!="" &&  $_POST['sex'] !="Select"){
                  $location = $_POST['location'];
				  $occupuation = $_POST['occupation'];
				...
				if(isset($_POST['filter'])  && $_POST['location']!="Select" && $_POST['occupation']!='Select' && $_POST['age']!="" &&  $_POST['sex'] =="Select"){
                  ...
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE age<='$age' AND borough = '$location' AND occupation='$occupuation';";
                }
				 ...
				 if(isset($_POST['filter']) &&  $_POST['location']=="Select" && $_POST['occupation']!='Select' && $_POST['age']!="" &&  $_POST['sex'] !="Select"){
                  ...
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE age<='$age' AND gender='$sex' AND occupation='$occupuation';";
                }
				 if(isset($_POST['filter']) && $_POST['location']!="Select" && $_POST['occupation']!='Select' && $_POST['age']=="" &&  $_POST['sex'] =="Select"){
                  $location = $_POST['location'];
				  $occupuation = $_POST['occupation'];
				 ...
				 $sex = $_POST['sex'];
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE borough='$location' AND occupation='$occupuation';";
                }
				 if(isset($_POST['filter']) && $_POST['location']!="Select" && $_POST['occupation']=='Select' && $_POST['age']=="" &&  $_POST['sex'] !="Select"){
                  $location = $_POST['location'];
				  $occupuation = $_POST['occupation'];
				 ...
				 $sex = $_POST['sex'];
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE borough='$location' AND gender='$sex';";
                }
				 ...
				 $sex = $_POST['sex'];
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE borough='$location' AND age<='$age';";
                }
				 ...
				 $sex = $_POST['sex'];
                  $query = "SELECT drinkers.drinker_id, name, gender, age, drinkname, borough, occupation
                          FROM prefs LEFT JOIN drinkers ON drinkers.drinker_id = prefs.drinker_id
                          WHERE borough='$location' AND age<='$age' AND gender='$sex';";
                }
                $result = $mysqli->query($query) or die($mysqli->error . __LINE__);
                while($row = $result->fetch_array()){
                 ?>
