        ...
        <div class="row">
			...
			<h1> What is Meet & Drink? </h1>
				<div class="col-lg-9 col-xs-9">
					...
					It is aimed at single individuals between the ages of 21 and 33 in New York. Meet & Drink helps to set people up 
					based on what beer they like, what field are they in, as well as their age group. It even helps people who just want a 
					cheap beer, providing them with information about the location and time of the happy hour.
					</p> 
				</div>
			</div>
			<div class="col-lg-12 col-xs-12">
			<h1> What makes us different?  </h1>
				<div class="col-lg-9 col-xs-9">
					<p>Unlike other services, we focus on getting people connected based on similiar aspects. This application is great for 
					someone who wants to impress their friends with their drinking knowledge with our advanced drink suggestor.
					</p> 
					</div>
				</div>
				<div class="col-lg-12 col-xs-12">
			<h1> What do we offer? </h1>
					<div class="col-lg-9 col-xs-9">
						...
						maybe find a boyfriend or girlfriend who works in the same field as you, preferably someone around your age.
						We have you covered! Using our database you can input which borough of NYC you live in, what occupation you are looking 
						for, what age range would you want, and finally the gender of whom you are looking to meet. Using our database of
						thousands of individuals we are able to suggest the top drinks, and similiar traits you may have.</p> 
					</div>
				</div>
			...
			<h1> Value Proposition: </h1>
					<div class="col-lg-9 col-xs-9">
						<p>Our research has been able to gather data about the popular trends in NYC. With this data, we are able to offer 
						you which bars have the cheapest prices, including happy hour. Our database also accounts for those that are unable to 
						make it to a regular happy hour, including the bars with the latest happy hours. Our database web application is differentiated by 
						others, since it helps to match individuals by occupations and find their special someone in a certain area or field. 
						We even help you once you get to the bar. We also have accumulated a list of the most popular drinks. For instance, you might be looking to buy 
		that girl 
						or guy across the bar a drink, but do not know which drink they would prefer. We have data that helps to provide the most 
