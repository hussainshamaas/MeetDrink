...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="../3"><i class="fa fa-beer"></i> <span>Cheapest bar</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cheapest Bar. 
        <small> in a particular location.</small>
      </h1>
      </section>
    ...
    <section class="content">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Cheapest bars.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">

            <form method="POST" action="">
              <strong>Location: </strong><select style="margin-bottom: 10px;  margin-right: 10px;" name="location">
                <option>Select</option>
                <?php
                  $query = "SELECT DISTINCT(borough) FROM bars ORDER BY borough;";
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                $query = "SELECT barname, borough, avgbeerprice FROM bars WHERE borough = 'Bronx' ORDER BY avgbeerprice;";
                if(isset($_POST['filter'])){
                  $location = $_POST['location'];
                  $query = "SELECT barname, borough, avgbeerprice FROM bars WHERE borough = '$location' ORDER BY avgbeerprice;";
                }
                $result = $mysqli->query($query) or die($mysqli->error . __LINE__);
                while($row = $result->fetch_array()){
                 ?>
                <tr>
                  ...
                  <td><?php echo $row['avgbeerprice']?></td>
                </tr>
                <?php
                }
                ?>
